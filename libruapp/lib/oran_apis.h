...
#define T2A_MAX_UP "/o-ran-delay-management:delay-management/bandwidth-scs-delay-state[bandwidth=100000][subcarrier-spacing=30000]/ru-delay-profile/t2a-max-up"

#define T2A_MIN_UP "/o-ran-delay-management:delay-management/bandwidth-scs-delay-state[bandwidth=100000][subcarrier-spacing=30000]/ru-delay-profile/t2a-min-up"

#define T2A_MAX_CP_DL "/o-ran-delay-management:delay-management/bandwidth-scs-delay-state[bandwidth=100000][subcarrier-spacing=30000]/ru-delay-profile/t2a-max-cp-dl"

#define T2A_MIN_CP_DL "/o-ran-delay-management:delay-management/bandwidth-scs-delay-state[bandwidth=100000][subcarrier-spacing=30000]/ru-delay-profile/t2a-min-cp-dl"

#define TADV_CP_DL "/o-ran-delay-management:delay-management/bandwidth-scs-delay-state[bandwidth=100000][subcarrier-spacing=30000]/ru-delay-profile/tcp-adv-dl"

#define T2A_MIN_CP_UL "/o-ran-delay-management:delay-management/bandwidth-scs-delay-state[bandwidth=100000][subcarrier-spacing=30000]/ru-delay-profile/t2a-min-cp-ul"

#define T2A_MAX_CP_UL "/o-ran-delay-management:delay-management/bandwidth-scs-delay-state[bandwidth=100000][subcarrier-spacing=30000]/ru-delay-profile/t2a-max-cp-ul"

#define TA3_MIN "/o-ran-delay-management:delay-management/bandwidth-scs-delay-state[bandwidth=100000][subcarrier-spacing=30000]/ru-delay-profile/ta3-min"

#define TA3_MAX "/o-ran-delay-management:delay-management/bandwidth-scs-delay-state[bandwidth=100000][subcarrier-spacing=30000]/ru-delay-profile/ta3-max"

#define T1A_MAX_UP "/o-ran-delay-management:delay-management/adaptive-delay-configuration/bandwidth-scs-delay-state[bandwidth=100000][subcarrier-spacing=30000]/o-du-delay-profile/t1a-max-up"

#define T1A_MAX_CP_DL "/o-ran-delay-management:delay-management/adaptive-delay-configuration/bandwidth-scs-delay-state[bandwidth=100000][subcarrier-spacing=30000]/o-du-delay-profile/t1a-max-cp-dl"

#define TA4_MAX "/o-ran-delay-management:delay-management/adaptive-delay-configuration/bandwidth-scs-delay-state[bandwidth=100000][subcarrier-spacing=30000]/o-du-delay-profile/ta4-max"
...
#define NRBSTART1 "/o-ran-uplane-conf:user-plane-configuration/static-srs-configurations/srs-patterns[srs-pattern-id=1]/start-prbc"

#define NRBSIZE1 "/o-ran-uplane-conf:user-plane-configuration/static-srs-configurations/srs-patterns[srs-pattern-id=1]/num-prbc"

#define NUMSYMB1 "/o-ran-uplane-conf:user-plane-configuration/static-srs-configurations/srs-patterns[srs-pattern-id=1]/num-symbol"

#define NBEAMINDEX1 "/o-ran-uplane-conf:user-plane-configuration/static-srs-configurations/srs-patterns[srs-pattern-id=1]/beam-id"

#define NRBSTART0 "/o-ran-uplane-conf:user-plane-configuration/static-srs-configurations/srs-patterns[srs-pattern-id=0]/start-prbc"

#define NRBSIZE0 "/o-ran-uplane-conf:user-plane-configuration/static-srs-configurations/srs-patterns[srs-pattern-id=0]/num-prbc"

#define NUMSYMB0 "/o-ran-uplane-conf:user-plane-configuration/static-srs-configurations/srs-patterns[srs-pattern-id=0]/num-symbol"

#define NBEAMINDEX0 "/o-ran-uplane-conf:user-plane-configuration/static-srs-configurations/srs-patterns[srs-pattern-id=0]/beam-id"

#define IQWIDTH "/o-ran-uplane-conf:user-plane-configuration/low-level-rx-endpoints/compression/iq-bitwidth"

#define NFRAMEDUPLEXTYPE "/o-ran-uplane-conf:user-plane-configuration/tx-array-carriers/rw-duplex-scheme"

#define CCNUM "/o-ran-uplane-conf:user-plane-configuration/low-level-rx-endpoints/e-axcid/eaxc-id"

#define SCS "/o-ran-delay-management:delay-management/bandwidth-scs-delay-state/subcarrier-spacing"		//to derive value for mu

#define CMPMTHD "/o-ran-uplane-conf:user-plane-configuration/low-level-tx-endpoints/compression/dynamic-compression-configuration/compression-method"

#define RUMAC0 "/o-ran-processing-element:processing-elements/ru-elements[name='ps_ru_element_eth0_u']/transport-flow/eth-flow/ru-mac-address"

#define duMac0 "/o-ran-processing-element:processing-elements/ru-elements[name='ps_ru_element_eth0_u']/transport-flow/eth-flow/o-du-mac-address"

#define NDLFFTSIZE "/o-ran-uplane-conf:user-plane-configuration/low-level-tx-endpoints/frame-structure"
